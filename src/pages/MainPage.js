		...
		<div className="MainPage -mt-16">
			...
			<div className="mx-auto">
				...
				<TwoColumns
					bgColor={'#f4f4f4'}
					columns={[
						<img data-src={main_items} alt={`Items`} className={`observeImg`}/>,
						<Meta
							title={'Items'}
				...
				<TwoColumns
					...
					columns={[
						<Meta
							...
							btnLink={'/part'}
						/>,
						<img data-src={main_parts} alt='Parts of Longboard' className={`observeImg`} />,
					]}
					mobileReverse={true}
				/>
				<TwoColumns
					bgColor={'#f4f4f4'}
					columns={[
						<img data-src={main_styles}  alt='Riding Styles' className={`observeImg`} />,
						<Meta
							title={'Riding Styles'}
